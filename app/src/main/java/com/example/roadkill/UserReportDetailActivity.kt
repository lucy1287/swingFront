...
//
//class UserReportDetailActivity : AppCompatActivity() {
//    private lateinit var binding: ActivityUserReportDetailBinding
...
//        binding = ActivityUserReportDetailBinding.inflate(layoutInflater)
...
//            val title = binding.etAccidentRoadInfo.text.toString()
//            val detail = binding.etAccidentDetailInfo.text.toString()
//            if(title == "" || detail == "")
...
//        }
//
//        reportImageRVAdapter = ReportImageRVAdapter(reportImageList, )
