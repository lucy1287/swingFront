...
class ReceiptImageRVAdapter(private var imageList: ArrayList<*>, private val activity: ManagerReceiptDetailActivity) :
    RecyclerView.Adapter<ReceiptImageRVAdapter.ViewHolder>() {
